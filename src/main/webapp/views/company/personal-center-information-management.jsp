...
<head>
    ...
    <link href="/public/stylesheets/personal-center-information-management.css" type="text/css" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div id="first">
            ...
            <div class="box">
                <div id="first_left">
                        <div class="block">
                            <p>公司名称：<%= userInfo.get("companyName")%>&nbsp;<span><a class="noBackground" href="http://www.fujianxinghua.com/">[公司官网]</a></span></p><br/>
                            <p>公司类型：<%= userInfo.get("companyType")%></p><br/>
                            <p>所属行业：<%= userInfo.get("workingFiled")%></p><br/>
                            <p>咨询电话：<%= userInfo.get("consultPhone")%></p><br/>
                            <p>主营业务：<%= userInfo.get("majorAffair")%></p><br/>
                            <p>盈利模式：产品金字塔模式</p><br/>
                            <p>注册资本：<%= userInfo.get("registerCapital")%></p><br/>
                            <p>营业执照注册号：<%= userInfo.get("businessLisence")%></p><br/>
                            <p>法人代表：<%= userInfo.get("legalPresentative")%></p><br/>
                        </div>
                    </div>
                <div id="first_right">
                        <div class="block">
                        ...
                        <div class="block">
                            <br/><br/>
                            <p>注册时间：<%= userInfo.get("formedTime")%></p><br/>
                            <p>总部地址：<%= userInfo.get("baseAddress")%></p><br/>
                            <p>当前信用评级：AAA</p>
                        </div>
                    </div>
            </div>
        ...
        <div id="second">
            ...
            <div class="box">
                ...
                <div id="button2"><a href="/company/isource.htm">编辑</a></div>
            </div>
        </div>
    </div>
</div>
